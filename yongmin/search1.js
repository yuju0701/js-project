...
const render = (movies) => {
  ...
  movies.forEach((movie) => {
    ...
    <div class="search-result">
      <div onclick="recommendation(${movie.id})" class="col-lg-4 search-result__img">
      ${
        poster
          ? `<img src="https://image.tmdb.org/t/p/w200${poster}" alt="${title || name} 포스터">`
          : "<p>포스터 이미지가 없습니다.</p>"
      }   
    </div>
      <div class="col-lg-8">
