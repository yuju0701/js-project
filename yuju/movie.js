...
const latestMovieRender = (movie) => {
  ...
  let latestHTML = `
    <div class = "MovieInfo slide" onclick="openDetailPage(${movie.id})" draggable="false">
       
          
            <img src="${movie.poster_path?`https://image.tmdb.org/t/p/w200${movie.poster_path}`: defaultImage}" draggable="false" alt="${movie.title} 포스터" style="width: 200px; height: 300px; border-radius: 5%; border-radius: 5%; border: 0.01px solid gray; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.5);">
